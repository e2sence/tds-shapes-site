...
Object(function webpackMissingModule() { var e = new Error("Cannot find module './src/tds-shapes/tds-shapes-entry'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
 ...
 */
const lm = (s, p) => {
    return new Object(function webpackMissingModule() { var e = new Error("Cannot find module './src/tds-shapes/tds-shapes-entry'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(la(s, p)).draggable();
};
...
let sliderDemo = Object(function webpackMissingModule() { var e = new Error("Cannot find module './src/tds-shapes/tds-shapes-entry'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(draw);
slidersGroup
    .rect(400, 400)
    .radius(20)
    .fill({ color: '#EEEEEE' })
